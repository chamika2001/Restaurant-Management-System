...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="navbar">
            ...
            <div class="al">
                <h4 class="ph4">T H A N K Y O U S E N D U S A M E S S A G E</h4>
                <br>
                <h1>Check Your Email!<br>Thank You For Send us a message</h1>
                <br><br>
                <a class="bt" href="contact.php">Send another message</a>
            </div>
        </div>
